...
- **Principal component analysis**[^1] is a linear dimensionality reduction technique used to remap original datapoints along "principal axes" best describing the variance in the data.
...
- **T-distributed Stochastic Neighbor Embedding**[^2] is a non-linear technique aimed at preserving the relative distant between data points. Compared to PCA, it handles outliers better and preserve the local structure in the data.
...
- **Gaussian Mixture Models**[^3] are probabilistic models that assume the datapoints are generated from a mixture of Gaussian distributions (or components).
...
## References
[^1]: [Everything you did and didn't know about PCA](https://alexhwilliams.info/itsneuronalblog/2016/03/27/pca/), by Alex Williams.

[^2]: [t-SNE implementations](https://lvdmaaten.github.io/tsne/), by Laurens van der Maaten.

[^3]: [GMM with scikit-learn](https://scikit-learn.org/stable/modules/mixture.html), `scikit-learn` user guide.
